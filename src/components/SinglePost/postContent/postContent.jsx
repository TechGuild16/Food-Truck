  ...
  return (
    <div className="d-flex flex-wrap justify-content-center align-items-start main-container">
      ...
      <div className="image-container">
        ...
        <div className=" my-5">
          <div style={{ borderRadius: "10px" }}>
            <h4 className="text-dark fw-bold">LEAVE A REPLY</h4>
            ...
            <div className="mb-3">
              <label className="text-dark fw-bold" htmlFor="name">
                Name *
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label className="text-dark fw-bold" htmlFor="email">
                Email *
              </label>
              <input
                type="email"
            ...
            <div className="mb-3">
              <label className="text-dark fw-bold" htmlFor="website">
                Website
              </label>
              <input
                type="text"
            ...
            <div className="mb-3">
              <label className="text-dark fw-bold" htmlFor="comment">
                Comment *
              </label>
              <textarea
                className="form-control"
            ...
            <div className="mb-3 form-check">
              <input
                ...
                id="saveInfo"
              />
              <label className="form-check-label text-dark" htmlFor="saveInfo">
      ...
      <div className="content-container d-flex flex-column align-items-center">
        ...
        <div
          className="second mt-4 p-4"
          style={{
            maxWidth: "400px",
            borderRadius: "10px",
          }}
        >
          <h5 className="fw-bold text-white" style={{color :" white !important"}}>HAVE ANY QUESTION?</h5>
          <p className="mb-3">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit
            tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.
          </p>
          <p className="d-flex align-items-center gap-2">
            <FaPhoneAlt className="text-white" /> (+62) 81 2345 6789
          </p>
          <p className="d-flex align-items-center gap-2">
            <FaEnvelope className="text-white" /> delitruck@domain.com
          </p>
        </div>
